...
const PrivacyPolicy = () => {
  return <div className='privacy-policy'>
    ...
    <div className='statement'>PRIVACY STATEMENT</div>
    <div>
    <div className='div-heading'>SECTION 1 – WHAT DO WE DO WITH YOUR INFORMATION?</div>
    ...
    <div>
    <div className='div-heading'>SECTION 2 – CONSENT</div>
    <div className='div-content'>
    <p>How do you get my consent?</p>
    <p>When you provide us with personal information to complete a transaction, verify your credit card, place an order, arrange for a delivery or return a purchase, we imply that you consent to our collecting it and using it for that specific reason only.</p>
    <p>If we ask for your personal information for a secondary reason, like marketing, we will either ask you directly for your expressed consent, or provide you with an opportunity to say no.</p>
    <p>How do I withdraw my consent?</p>
    <p>If after you opt-in, you change your mind, you may withdraw your consent for us to contact you, for the continued collection, use or disclosure of your information, at anytime, by contacting us at <span>info@logger-india.com</span> or mailing us at: <span>55-A, Mohan Nagar II, Iskcon Rd, Mansarovar, Jaipur, Rajasthan 302020,India</span></p>
    </div>
    </div>
    <div>
    <div className='div-heading'>SECTION 3 – DISCLOSURE</div>
    <div className='div-content'>
        <p>We may disclose your personal information if we are required by law to do so or if you violate our Terms of Service.</p>
        <p className='spacing-thing'>If our store is acquired or merged with another company, your information may be transferred to the new owners so that we may continue to sell products to you.</p>
   
    </div>
    </div>
    <div>
<div className='div-heading'>SECTION 4 – PAYMENT</div>
<div className='div-content'>
...
<div>
    <div className='div-heading'>SECTION 5 – THIRD-PARTY SERVICES</div>
    <div className='div-content'>
...
<div>
    <div className='div-heading'>SECTION 6 – SECURITY</div>
    <div className='div-content'>
<p>To protect your personal information, we take reasonable precautions and follow industry best practices to make sure it is not inappropriately lost, misused, accessed, disclosed, altered or destroyed.</p>
    </div>
</div>
<div>
    <div className='div-heading'>SECTION 7 – COOKIES</div>
    <div className='div-content'>
...
<div>
    <div className='div-heading'>SECTION 8 – AGE OF CONSENT</div>
    <div className='div-content'>
<p> By using this site, you represent that you are at least the age of majority in your state or province of residence, or that you are the age of majority in your state or province of residence and you have given us your consent to allow any of your minor dependents to use this site.</p> 
    </div>
</div>
<div>
    <div className='div-heading'>SECTION 9 – CHANGES TO THIS PRIVACY POLICY</div>
    <div className='div-content'>
    ...
    <p>If you would like to: access, correct, amend or delete any personal information we have about you, register a complaint, or simply want more information contact our Privacy Compliance Officer at <span>info@logger-india.com</span> or mailing us at: <span>55-A, Mohan Nagar II, Iskcon Rd, Mansarovar, Jaipur, Rajasthan 302020,India</span></p>
    </div>
</div>
