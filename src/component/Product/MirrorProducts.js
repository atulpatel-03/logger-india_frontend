...
const MirrorProducts = ({ match }) => {
  ...
  const [category, setCategory] = useState("Mirrors");
  ...
  useEffect(async () => {
    ...
    await dispatch(getAllSubCategory("6217ae557f2c674264bde57f"));
